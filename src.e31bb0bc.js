...
var CONTRACT_NAME = "dev-1637291360806-46532395801310" || 'say-hello.dobleuber.testnet';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/Users/wcastrov", "/.near/validator_key.json"),
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return new _nearApiJs.Contract(window.walletConnection.account(), nearConfig.contractName, {
              ...
              viewMethods: ['get_greetings', 'get_last_greeting'],
...
document.querySelector('form').onsubmit = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
    var _event$target$element, fieldset, greeting, helloMessage;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 3;
            _context.next = 6;
            return window.contract.say_hi({
              // pass the value that the user entered in the greeting field
              message: greeting.value
            });

          case 6:
            helloMessage = _context.sent;
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return contract.get_last_greeting({
              account_id: window.accountId
            });

          case 2:
            currentGreeting = _context2.sent;
            document.querySelectorAll('label[data-behavior=greeting]').forEach(function (el) {
              // set divs, spans, etc
            ...
            _context2.next = 6;
            return contract.get_greetings({
              account_id: window.accountId
            });

          case 6:
            currentGreeting = _context2.sent;
            userList = document.querySelector('#greeting-list');
            userList.innerHTML = '';
            currentGreeting.slice(Math.max(currentGreeting.length - 5, 1)).forEach(function (el) {
              var userItem = document.createElement('li');
              userItem.innerText = el;
